...
cctm.file <- './data/combine_egus_so2/HR2DAY_ES2_ASENS_v54_DDM3D_gcc_AQF5X_202001.nc'
...
save(df, file=paste0("./data/",selected.species,"/combined.so4.block.groups.2013.2019.RData"))
